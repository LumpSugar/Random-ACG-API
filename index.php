...
<html>
	<head>
		...
		<title>随机二次元图片API - Nanami's 背景API接口站</title>
		<meta name="keywords" content="Nanami's背景API接口站">
	...
	<body>
		<div>
			<p algin=“center” class="title title2">随机二次元图片API - Nanami's背景API接口站</p>
		</div>
		<div class="container">
			<div class="well">
				<p>目前背景共收录 100+ 张图片，随机图床胡乱增加中，预计最终数量一万多， API最后更新时间:2024-10-25</p>
				<p>基本完成pc端背景个人xp化</p>
				<p>同下：</p>
				...
				<pre>json/images</pre>
				<p>博客</p>
				<pre><a href="https://blog.450806.xyz" target="_blank">https://blog.450806.xyz</a></pre>
			</div>
		</div>
		<div class="bottom">

                    <p>China © 2021-2099 <a href="https://blog.450806.xyz" target="_blank" class="one-pan-link-mark">博客</a></p>
		</div>
	</body>
</html>
